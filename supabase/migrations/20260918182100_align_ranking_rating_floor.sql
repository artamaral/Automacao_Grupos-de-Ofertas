-- Align base ranking eligibility with the productCatId catalog contract.
-- The commercial rating score already starts at 4.5; this migration removes
-- the older 4.8 hard block from the canonical ranking view.
...
scored as (
  select
    ...
    array_remove(
      array[
        case when rating < 4.5 then 'rating_below_4_5' end,
...
comment on view offers.v_offer_ranking_current is
  'Canonical offer ranking. Eligibility uses rating >= 4.5, valid price/link, cooldown and similarity checks.';
