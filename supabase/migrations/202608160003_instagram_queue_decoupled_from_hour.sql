...
comment on view offers.v_instagram_dispatch_ready is
  'Superficie pronta para o workflow Instagram; planned_hour permanece apenas como auditoria herdada do planner, enquanto o n8n define o horario efetivo da publicacao.';
